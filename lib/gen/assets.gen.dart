...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/shredder.json
  LottieGenImage get shredder =>
      const LottieGenImage('assets/animations/shredder.json');

  /// List of all assets
  List<LottieGenImage> get values => [shredder];
}
...
class $AssetsOnBoardingGen {
  ...
  /// File path: assets/on_boarding/on_boarding_1.jpg
  AssetGenImage get onBoarding1 =>
      const AssetGenImage('assets/on_boarding/on_boarding_1.jpg');

  /// File path: assets/on_boarding/on_boarding_3.jpg
  AssetGenImage get onBoarding3 =>
      const AssetGenImage('assets/on_boarding/on_boarding_3.jpg');

  /// File path: assets/on_boarding/on_bording_2.jpg
  AssetGenImage get onBording2 =>
      const AssetGenImage('assets/on_boarding/on_bording_2.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [onBoarding1, onBoarding3, onBording2];
}
