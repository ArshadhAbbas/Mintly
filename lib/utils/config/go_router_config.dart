...
class GoRouterConfig {
  static final GoRouter _router = GoRouter(
    initialLocation: prefs?.getBool("didShow") != null && prefs!.getBool("didShow")!
        ? AuthenticatorView.path
        : OnBoardingView.path,
    routes: [
      GoRouterRoute(
        pathRoute: OnBoardingView.path,
        pathRouteName: OnBoardingView.pathName,
      ...
      GoRouterRoute(
        pathRoute: BottomNavView.path,
        pathRouteName: BottomNavView.pathName,
        builder: (context, state) => BottomNavView(),
      ),
      GoRouterRoute(
        pathRoute: CategoriesView.path,
        pathRouteName: CategoriesView.pathName,
      ...
      GoRouterRoute(
        ...
        builder: (context, state) => AddCardView(),
      ),
      GoRouterRoute(
        pathRoute: AddNewBankAccount.path,
        pathRouteName: AddNewBankAccount.pathName,
        builder: (context, state) => AddNewBankAccount(),
      ),
    ],
