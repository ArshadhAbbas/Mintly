...
class AccountsView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var cashBoxHive = Hive.box<CashModel>(HiveBoxes.cashBox);
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
      ...
      body: ValueListenableBuilder(
        valueListenable: cashBoxHive.listenable(),
        builder: (context, cashBox, child) => bankAccounts.isEmpty && cards.isEmpty && cashBoxHive.isEmpty
            ? Center(
                child: InkWell(
                          ...
                          ? Column(
                              ...
                              children: [
                                ...
                                AccountsCard(
                                  ...
                                  title: cashBox.values.first.balanceAmount,
                                  onUpdate: () {
                                    showModalBottomSheet(
                                      ...
                                      builder: (context) =>
                                          AddCashBottomSheet(isUpdating: true, currentAmount: cashBox.values.first.balanceAmount),
                                    );
                                  },
                                  onDelete: () {
                                    cashBox.clear();
